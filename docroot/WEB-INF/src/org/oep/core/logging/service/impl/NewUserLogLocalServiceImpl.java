...
public class NewUserLogLocalServiceImpl extends NewUserLogLocalServiceBaseImpl {
	 ...
	 * @return Integer
	 */
	public int countByParam(String keyWord, boolean isUserName, boolean isEmail, Date fromDate, Date toDate,ServiceContext serviceContext){
	 ...
	 */
	public List<NewUserLog> getByParam(String keyWord, boolean isUserName, boolean isEmail, Date fromDate, Date toDate,ServiceContext serviceContext, int begin, int end){
