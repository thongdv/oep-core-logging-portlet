...
Date fromDate = DateUtil.parseStringToDate(strFromDate, DateUtil.DATE_FORMAT_D_M_Y);
Date toDate = DateUtil.parseStringToDate(strToDate, DateUtil.DATE_FORMAT_D_M_Y);
